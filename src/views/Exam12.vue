...
.essayTitle{
  ...
  padding: 1rem;
  color: #3c3c3c;
  border-bottom: #95a5a6 solid 2px;
}
.content{
  padding:2rem;
  font-size: 1.5rem;
...
.tests ul li label .option_inner {
  width: 100%;
  height: 100%;
  background: #ecf0f1;
  border-radius: 20px;
...
.tests ul li label .checkbox:checked ~ .option_inner.all {
  border-color: black;
  background: #00b894;
